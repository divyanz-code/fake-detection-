...
export const RegisterScreen: React.FC = () => {
  const { registerUser, navigateTo, error, clearError } = useApp();
    ...
    <View style={[styles.container, isDark ? styles.bgDark : styles.bgLight]}>
      <View style={styles.formContainer}>
        ...
        <Text style={[styles.subtitle, isDark ? styles.textSecondaryDark : styles.textSecondaryLight]}>
          Join AegisFace to analyze facial media for manipulations.
        </Text>
        ...
        <View style={styles.inputGroup}>
          <Text style={[styles.inputLabel, isDark ? styles.textWhite : styles.textDark]}>Confirm Password</Text>
          <TextInput
            style={[styles.input, isDark ? styles.inputDark : styles.inputLight]}
            placeholder="••••••••"
            placeholderTextColor={isDark ? "#6B7280" : "#9CA3AF"}
